...
/**
 * Estilo Premium para o Carrossel da Sidebar do Blog
 */
/**
 * UÔNIX: Estilo Premium para o Carrossel da Sidebar do Blog (WCPS 8643)
 * Blindado contra configurações nativas do plugin.
 */
add_action('wp_head', 'uonix_estilos_carrossel_sidebar');

function uonix_estilos_carrossel_sidebar() {
    ?>
    <style>
    /* ==========================================================================
       UÔNIX: CARROSSEL DA SIDEBAR (WCPS-8643)
       ========================================================================== */

    /* 1. O CONTAINER BASE (A caixa branca em volta de tudo) */
    .wcps-container-8643 {
        width: 100% !important;
    ...
    /* 2. CARD DO PRODUTO (Sem bordas internas) */
   ...
   /* 3. IMAGEM DESTACADA (Aspect Ratio 4:3 e Centralização Perfeita) */
    ...
    /* A MÁGICA DA CENTRALIZAÇÃO: Faz o link e a div interna ocuparem 100% e centraliza tudo */
    ...
    .wcps-container-8643 .layer-media img {
        width: 100% !important;
        height: 100% !important;
    ...
    .wcps-container-8643 .elements-wrapper:hover .layer-media img {
        transform: scale(1.08) !important;
    }

    /* 4. TÍTULO DO PRODUTO (Tamanho fixo para não quebrar a altura dos slides) */
    ...
    /* 5. OCULTAR LIXO DO PLUGIN (Preço, Botões e Textos extras) */
    ...
    /* ==========================================================================
       6. PAGINAÇÃO (BOLINHAS DE NAVEGAÇÃO) - BLINDADO CONTRA O PLUGIN
       ========================================================================== */
    /* Container das bolinhas */
    .wcps-container-8643 .splide__pagination {
        position: relative !important;
        bottom: auto !important;
        margin: 20px 0 0 0 !important; /* Espaço entre o título e as bolinhas */
        padding: 0 !important;
        display: flex !important;
        justify-content: center !important;
        align-items: center !important;
    ...
    .wcps-container-8643 .splide__pagination li {
        margin: 0 !important;
        display: flex !important;
    }
    
    /* A Bolinha Padrão (Cinza Claro, Menorzinha) */
    .wcps-container-8643 .splide__pagination button.splide__pagination__page {
    ...
    /* A Bolinha Ativa (Pílula Laranja Uônix) */
    .wcps-container-8643 .splide__pagination button.splide__pagination__page.is-active,
    .wcps-container-8643 .splide__pagination button.splide__pagination__page:hover {
    ...
    /* ==========================================================================
       7. SETAS DE NAVEGAÇÃO LATERAIS (Opcionais, visíveis apenas no hover)
       ========================================================================== */
    ...
    .wcps-container-8643 .splide__arrow {
        ...
        opacity: 0 !important; /* Invisível até o hover */
        transition: all 0.3s ease !important;
        padding: 0 !important;
        transform: translateY(-50%) !important;
    }
    .wcps-container-8643:hover .splide__arrow { opacity: 0.9 !important; }
    .wcps-container-8643 .splide__arrow:hover {
        ...
        box-shadow: 0 6px 14px rgba(247, 106, 12, 0.2) !important;
    }
    .wcps-container-8643 .splide__arrow i,
    .wcps-container-8643 .splide__arrow svg { font-size: 14px !important; margin: 0 !important; }
    .wcps-container-8643 .splide__arrow.prev { left: -18px !important; }
    .wcps-container-8643 .splide__arrow.next { right: -18px !important; left: auto !important; }
    </style>

	<script>
		jQuery(document).ready(function($) {
			// INJETA O TÍTULO PREMIUM NA SIDEBAR
			if ($('.wcps-container-8643').length && $('.wcps-container-8643 .uonix-section-title').length === 0) {
				$('.wcps-container-8643').prepend('<h3 class="uonix-section-title">Em Destaque</h3>');
			}

			// TROCA <br> POR " - " NOS TÍTULOS
			$('.wcps-container-8643 .wcps-items-title a').each(function() {
				var html = $(this).html();
