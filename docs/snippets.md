...
Comportamentos que variam por ambiente devem usar o helper versionado em `mu-plugins/uonix-shared/environment.php`, sem duplicar hostnames em snippets visuais. O contrato canônico cobre produção (`https://uonix.com.br/`), QA (`https://uonix.ksio.dev/`) e local (`http://localhost:8080/`) em [ambientes.md](ambientes.md).
